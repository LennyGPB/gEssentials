  ...
  return (
    <>
        ...
        <article className="relative flex flex-col bg-gradient-to-br from-blackgradient to-blackgradient2 items-center border border-white text-white my-5 mx-96  shadow-md shadow-white">
          ...
          Nesciunt, illum? Beatae tempora inventore eum minima omnis sunt cupiditate aperiam blanditiis doloribus. Consectetur delectus soluta est provident sed sint officiis error deleniti suscipit magni doloribus laboriosam, dolores facilis quibusdam!
          Asperiores recusandae suscipit fuga voluptatibus dolor praesentium. Aperiam sit odio, ex rem libero corporis! </p>
